...
n_shot=4
python build_pp_bbbp.py --test_csv /cto_labs/AIDD/DATA/ChemLLMBench/property_prediction/BBBP_test.csv --train_csv /cto_labs/AIDD/DATA/ChemLLMBench/property_prediction/BBBP.csv --out_dir /cto_labs/AIDD/DATA/ChemLLMBench/ICL/pp/bbbp_${sample_strategy}_${n_shot}shot_int --n_shot ${n_shot} --sample_strategy ${sample_strategy}
"""